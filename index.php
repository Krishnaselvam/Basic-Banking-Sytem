 ...
 #wraper{
  ...
  ?>
      ...
      <!-- Introduction section -->
              ...
              <div class="col-sm-12 col-md">
                <div class="heading text-center my-5">
                  <img src="https://static.vecteezy.com/system/resources/previews/002/910/128/non_2x/closeup-of-business-woman-hand-putting-money-coin-into-piggy-bank-for-saving-money-saving-money-and-financial-concept-free-photo.jpg"  id="image-fluid">
                    <a href="#" style="text-decoration:none;"><h3>𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓𝐨 𝐒𝐊𝐁 </h3></a>
      ...
      <footer class="text-center mt-5 py-2">
        <p>&copy 2021. Made by <b>KRISHNAKUMAR</b> <br> SKB Foundation</p>
      </footer>
